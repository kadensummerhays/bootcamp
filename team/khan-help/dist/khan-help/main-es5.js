...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_mat_form_field_21_mat_option_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_mat_form_field_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_ng_container_26_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_ng_container_26_Template_input_ngModelChange_5_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r5.extraMinutes = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_ng_container_26_Template_input_ngModelChange_9_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.extraMinutesDays = $event;
        });
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(formBuilder) {
        ...
        this.daysOfWeek.forEach(function (day) {
          return _this.formGroup.addControl(day, new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.percentageMapping[0]));
        });
        Object.keys(this.percentageMapping).forEach(function (percent) {
          return _this.hoursMapping[_this.percentageMapping[percent]] = percent;
        });
        debugger;
      }
      ...
      _createClass(AppComponent, [{
        ...
        value: function getSum() {
          ...
          return this.daysOfWeek.reduce(function (acc, percentageAmount) {
            return acc + _this2.formGroup.controls[percentageAmount].value;
          }, 0);
        }
      }, {
        key: "getTotalPercentage",
        value: function getTotalPercentage() {
          var _this3 = this;

          return this.daysOfWeek.reduce(function (acc, percentageAmount) {
            var percentage = _this3.formGroup.controls[percentageAmount].value;

            if (!percentage) {
              return acc;
            }

            return acc + (_this3.percentageMapping[percentage] || 0);
          }, 0);
        }
      }, {
        key: "totalMathHours",
        value: function totalMathHours() {
          return this.formGroup.get('totalMathHours').value / 60;
        }
      }, {
        key: "extraTime",
        value: function extraTime() {
          return this.useExtraTime ? this.extraMinutes * this.extraMinutesDays / 60 : 0;
        }
      }, {
        key: "hoursThisWeek",
        value: function hoursThisWeek() {
          return this.totalMathHours() - this.extraTime();
        }
      }, {
        key: "remainingHours",
        value: function remainingHours() {
        ...
        key: "hoursCompleted",
        value: function hoursCompleted() {
          return this.hoursThisWeek() < 0 ? "0.00" : this.hoursThisWeek().toFixed(2);
        }
      }, {
        key: "hoursRemainingInfo",
        value: function hoursRemainingInfo() {
          var remainingHours = this.remainingHours();
          var percentage = this.getTotalPercentage();

          if (percentage >= 5) {
            return "You received ".concat(percentage, "%, so you're done!");
          }

          if (remainingHours <= 0) {
            return "".concat(Math.abs(remainingHours).toFixed(2), " Hours overtime this week. You're done!");
          }

          if (remainingHours > 0) {
            return "".concat(remainingHours.toFixed(2), " Hours left!");
          }
        }
      }]);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 40,
      vars: 8,
      consts: [["color", "primary"], [1, "fill"], ["mat-icon-button", "", "aria-label", "Example icon-button with heart icon", 1, "example-icon", "favorite-icon"], ["mat-icon-button", "", "color", "accent", "aria-label", "Example icon-button with share icon", 1, "example-icon"], [1, "container", 3, "formGroup"], [1, "days-of-week"], ["appearance", "outline"], ["matInput", "", "type", "number", "formControlName", "totalMathHours"], ["appearance", "outline", 4, "ngFor", "ngForOf"], [3, "checked", "toggleChange"], [4, "ngIf"], [3, "formControlName"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["matInput", "", "type", "number", 3, "ngModel", "ngModelOptions", "ngModelChange"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("toggleChange", function AppComponent_Template_mat_slide_toggle_toggleChange_22_listener() {
            return ctx.useExtraTime = !ctx.useExtraTime;
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_8__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_10__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_5__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_3__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_1__["MatButtonModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_2__["MatFormFieldModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_6__["MatSelectModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_7__["MatSlideToggleModule"]]]
    });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Workspace\kaden\team\khan-help\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
